          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                Daily Goals:{" "}
                {plan.limitations.maxDailyGoals
                  ? `${plan.limitations.maxDailyGoals} max`
                  : "Unlimited"}
              </div>
              <div className="flex items-center gap-2">
                <BarChart3 className="h-3 w-3" />
                Analytics:{" "}
                {plan.limitations.analytics ? "Full access" : "Not included"}
              </div>
              <div className="flex items-center gap-2">
                <Download className="h-3 w-3" />
                Data Export:{" "}
                {plan.limitations.exportData ? "Available" : "Not available"}
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Your data is always safe! If you downgrade from Premium to
                  Free, you'll lose access to premium features but all your
                  existing goals and progress will remain intact.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  You'll be billed monthly for your Premium subscription. Your
                  subscription will automatically renew each month unless you
                  choose to cancel. You can cancel anytime from your account
                  settings.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="max-w-2xl mx-auto border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-accent/20">
            <CardContent className="p-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Join thousands of users who have already unlocked their
